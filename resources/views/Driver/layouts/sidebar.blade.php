<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('Driver')}}">
      <div class="sidebar-brand-icon rotate-n-15">
        <i class="fas fa-laugh-wink"></i>
      </div>
      <div class="sidebar-brand-text mx-3">Driver</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('Driver-fuelrequests.index')}}">FuelTrack</a>
            <a class="collapse-item" href="{{route('Driver-fuelrequests.create')}}">Requestfuel</a>
          </div>
        </div>
    </li>
...
{{--
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="{{route('Driver.change.password.form')}}">
            <i class="fas fa-users"></i>
