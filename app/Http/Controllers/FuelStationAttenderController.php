...
class FuelStationAttenderController extends Controller
{
    /**
    ...
    //    dd($user->count());
       ...
       return view('FuelStationAttender.layouts.index')->with('user',$user)->with('fuelrequest',$fuelrequest)->with('fuelrequestC',$fuelrequestC);
    ...
    public function userAccount(){
        $user=Auth::user();
        return view('FuelStationAttender.layouts.users.profile',compact('user'));
    }
...
//         }
    ...
    public function changePassword(){
        ...
        return view('FuelStationAttender.layouts.users.userPasswordChange');//,compact('user'));
    }
